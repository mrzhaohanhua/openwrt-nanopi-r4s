...
# 定义变量
# openwrt_version_code="v24.10.2"
immortalwrt_version_code="openwrt-24.10"
...
# 不再替换openwrt文件，而是直接使用immortalwrt
...
# copy_package frp feeds/packages/net/frp
...
# copy_package golang feeds/packages/lang/golang
